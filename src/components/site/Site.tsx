...
function Page() {
  ...
  return (
    <>
      <header id="hdr">
        <div className="nav">
          <a href="#top" className="logo">
            <span style={{ width: 28, height: 28, display: "inline-block" }}>{logo()}</span>
          ...
          />
          <a href="#support" className="btn fill nav-cta" style={{ padding: "8px 14px", minHeight: 40 }}>
        ...
        <div className="wrap">
          <div className="hero-grid">
            <div>
              ...
              <div className="cta">
                <a href="#support" className="btn fill">
      ...
      <section className="sec" id="about">
        <div className="wrap">
          ...
          <div className="about-grid">
            ...
            <EText as="p" className="body" value={b.about.body} onChange={(v) => mut((d) => (d.about.body = v))} />
          </div>
          <div className="stats">
      ...
      <section className="sec steel" id="support">
        <div className="wrap">
          <SecHead idx={b.support.idx} label={b.support.label} onIdx={(v) => mut((d) => (d.support.idx = v))} onLabel={(v) => mut((d) => (d.support.label = v))} />
          <Heading pre={b.support.headingPre} ul={b.support.headingUnderline} onPre={(v) => mut((d) => (d.support.headingPre = v))} onUl={(v) => mut((d) => (d.support.headingUnderline = v))} max="16ch" />
          <EText as="p" className="body" style={{ maxWidth: "58ch", marginTop: 16 }} value={b.support.body} onChange={(v) => mut((d) => (d.support.body = v))} />
          <div className="rows">
      ...
      <section className="sec" id="sponsors">
        <div className="wrap">
          ...
          <Heading pre={b.sponsors.headingPre} ul={b.sponsors.headingUnderline} onPre={(v) => mut((d) => (d.sponsors.headingPre = v))} onUl={(v) => mut((d) => (d.sponsors.headingUnderline = v))} max="18ch" />
          <EText as="p" className="body" style={{ maxWidth: "56ch", marginTop: 16 }} value={b.sponsors.body} onChange={(v) => mut((d) => (d.sponsors.body = v))} />
          <div className="wall">
      ...
      <section className="sec steel" id="work">
        <div className="wrap">
          ...
          <div className="frames">
            {b.work.frames.map((f, i) => (
              <div className={`frame editable-item ${f.span}`} key={f.id}>
      ...
      <section className="sec" id="outreach">
        <div className="wrap">
          ...
          <Heading pre={b.outreach.headingPre} ul={b.outreach.headingUnderline} onPre={(v) => mut((d) => (d.outreach.headingPre = v))} onUl={(v) => mut((d) => (d.outreach.headingUnderline = v))} max="18ch" />
          <div className="olist">
      ...
      <section className="sec steel" id="contact">
        <div className="wrap">
      ...
      <footer>
        <div className="wrap">
          <div className="foot">
            <div>
              <div className="logo">
                <span style={{ width: 26, height: 26, display: "inline-block" }}>{logo()}</span>
                <EPlain value={b.brand.name} onChange={(v) => mut((d) => (d.brand.name = v))} />
              </div>
...
function Heading({ pre, ul, onPre, onUl, max }: { pre: Localized; ul: Localized; onPre: (v: Localized) => void; onUl: (v: Localized) => void; max?: string }) {
  return (
    <h2 className="t" style={{ maxWidth: max }}>
  ...
  if (editMode) {
    return (
      <div className="season">
        <div className="wrap season-in">
          {items.map((it, i) => (
            <span key={i} className="editable-item" style={{ position: "relative" }}>
              <ItemControls onDelete={() => mut((d) => d.marquee.items.splice(i, 1))} />
              <EText value={it} onChange={(v) => mut((d) => (d.marquee.items[i] = v))} />
            </span>
          ))}
          <AddButton label="Add season note" onClick={() => mut((d) => d.marquee.items.push(loc("New", "Yeni")))} />
        </div>
      </div>
    );
  }
  return (
    <div className="season" aria-hidden="true">
      <div className="wrap season-in">
        {items.map((it, i) => (
          <span key={i}>{pick(it, locale)}</span>
        ))}
      </div>
    </div>
  );
